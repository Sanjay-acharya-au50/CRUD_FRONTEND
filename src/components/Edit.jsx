    ...
    <div className='m-[50px] bg-[#dcdde1] p-2 rounded-lg'>
        ...
        <div >
            <form className='flex flex-col ' onSubmit={addUser}>
                <input type="text" name="name" value={obj.name} onChange={allObj} className='m-2  p-2 rounded' placeholder='name'/>
                <input type="text" name="email" value={obj.email} onChange={allObj} className='m-2  p-2 rounded' placeholder='email'/>
                <input type="text" name="bike" value={obj.bike} onChange={allObj} className='m-2  p-2 rounded' placeholder='bike'/>
